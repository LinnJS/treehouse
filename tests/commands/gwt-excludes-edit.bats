#!/usr/bin/env bats
# Tests for gwt-excludes-edit command

PLUGIN_DIR="${BATS_TEST_DIRNAME}/../.."

@test "gwt-excludes-edit: command is autoloadable" {
  run zsh -c "source ${PLUGIN_DIR}/treehouse.plugin.zsh && command -v gwt-excludes-edit"
  [ "$status" -eq 0 ]
}
