#!/usr/bin/env bats
# Tests for gwt-excludes-list command

PLUGIN_DIR="${BATS_TEST_DIRNAME}/../.."

@test "gwt-excludes-list: command is autoloadable" {
  run zsh -c "source ${PLUGIN_DIR}/treehouse.plugin.zsh && command -v gwt-excludes-list"
  [ "$status" -eq 0 ]
}
